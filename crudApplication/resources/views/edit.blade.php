                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{url('articles/edit/'.$article->id)}}" method="post" id="addArticle">
                            ...
                            <div class="form-group">
                                <label>Author</label>
                                <input type="text" name="author" id="author" class="form-control {{($errors->any() && $errors->first('author')) ? 'is-invalid' : ''}}" value="{{old('author', $article->author)}}">
                            ...
                            <div class="form-group">
                                <input type="submit" name="submit" class="btn btn-secondary" value="Update Article"/>
                            </div>  
                        </form>
                    </div>
                </div>
